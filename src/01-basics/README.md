...
Fundamentals: typed variables and functions, arrays and tuples, control flow, unions, enums, type aliases, interfaces, function overloads, and using interfaces to model API responses.
